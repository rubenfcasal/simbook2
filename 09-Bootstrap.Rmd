...
```{r muestra-sim, fig.cap="Distribución de la muestra simulada."}
...
```{r mean-boot-perc, fig.cap="Aproximación de la distribución de la media muestral mediante bootstrap percentil (uniforme)."}
...
```{r plot-res-boot, fig.width=12, fig.cap='Gráficos de diagnóstico de los resultados bootstrap de la mediana de los tiempos de vida de microorganismos.'}
plot(res.boot)
```
