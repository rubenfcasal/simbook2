...
Utilizando esta función generamos una muestra de tamaño 10000 y representamos gráficamente los valores obtenidos`r latexfig("cclayton2b-dispersion")`:
...
Podemos representar la densidad conjunta (con `sm::sm.density()`)`r latexfig("cclayton2b-conjunta")`:
...
y las distribuciones marginales`r latexfig("cclayton3-marginales")`:
