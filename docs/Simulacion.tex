...
\protect\hypertarget{exm:boot-maximo-uniforme}{}\label{exm:boot-maximo-uniforme}El siguiente código implementa el método
...
\textbf{\emph{Repositorio}}: \href{https://github.com/rubenfcasal/simbook2}{rubenfcasal/simbook2}
