...
Este repositorio se corresponde con la segunda edición del libro, **en proceso de elaboración** (la primera edición está disponible en el repositorio
[rubenfcasal/simbook](https://github.com/rubenfcasal/simbook) y compilada en [rubenfcasal.github.io/simbook](https://rubenfcasal.github.io/simbook))).
...
El libro ha sido escrito en [R-Markdown](http://rmarkdown.rstudio.com) empleando el paquete [`bookdown`](https://bookdown.org/yihui/bookdown/) y está disponible en el repositorio Github: [rubenfcasal/simbook2](https://github.com/rubenfcasal/simbook2). 
El libro (compilado) está disponible online en [rubenfcasal.github.io/simbook2](https://rubenfcasal.github.io/simbook2).
